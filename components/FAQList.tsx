...
export const generalFaqs: FAQItem[] = [
  ...
  { question:"標準返傭比例是多少？", answer:"標準交易者返傭比例為 20%。" },
  { question:"如何申請較高返傭級距？", answer:"可依最近 30 日有效交易量申請 25%～35%，並提交交易量、VIP 或其他帳戶條件供核對。" },
  { question:"達到交易量後會自動升級嗎？", answer:"不會。計算器顯示的是預估級距，實際比例須完成申請與資料核對。" },
