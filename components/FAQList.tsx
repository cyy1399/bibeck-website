...
export const generalFaqs: FAQItem[] = [
  ...
  { category:"Trader Status", question:"Trader Status 會改變 35% 標準返傭嗎？", answer:"不會。Member、Pro 與 Black 的 BiBeck 標準返傭比例皆為 35%。Trader Status 主要反映交易活動里程碑，以及高交易量活動、額外獎勵或合作方案的資格評估。" },
  ...
  { category:"Trader Status", question:"交易量下降後會被降級嗎？", answer:"BiBeck Trader Status 採里程碑概念，一般短期交易量下降不會自動降低標準 35% 返傭，也不應造成頻繁 Status 升降；當期額外獎勵、活動與合作資格仍可能依當期規則重新判定。" },
