        ...
        <section className="section-muted border-y border-white/10 px-5 py-20 sm:px-8">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-10 grid gap-6 lg:grid-cols-2">
              ...
              <article className="border border-gold/40 bg-gold/[0.04] p-6 sm:p-8"><p className="eyebrow">高交易量 / 專業交易</p><h3 className="mt-4 text-3xl font-semibold text-white">交易量越大，越值得重新檢視交易成本。</h3><p className="mt-5 text-sm leading-7 text-secondary">如果你有較高交易量、Quant、Bot、做市或其他專業交易需求，BiBeck 可依實際交易結構進一步評估。</p><ul className="mt-5 grid gap-2 text-sm text-white/68">{["VIP 與費率結構","Maker / Taker 成本","實際有效費率","高交易量合作需求","專屬條件評估"].map((item)=><li key={item}>— {item}</li>)}</ul><a href={HIGH_VOLUME_MAILTO} className="cta-button button-secondary mt-6">洽談高交易量方案</a></article>
            </div>
