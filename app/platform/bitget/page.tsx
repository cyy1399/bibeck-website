...
export const metadata: Metadata = createPageMetadata({ title: "Bitget 手續費與 VIP 等級比較", description: "整理 Bitget 現貨、合約、BGB 折扣與 VIP 手續費資訊，並比較返傭後的預估實際交易成本。", path: "/platform/bitget" });
