...
export const metadata: Metadata = createPageMetadata({ title: "Bybit 交易成本、VIP 與 35% 返傭", description: "查看 Bybit Maker／Taker 手續費、VIP 門檻、官方資料來源與 BiBeck 35% 標準返傭說明。", path: "/platform/bybit" });
