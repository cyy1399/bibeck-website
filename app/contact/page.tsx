...
export default function ContactPage() {
  return (
    <SiteShell>
      ...
      <section className="px-5 py-20 sm:px-8"><div className="mx-auto max-w-5xl"><div className="mb-8 border-l-2 border-gold bg-[#121212] p-6"><h2 className="text-xl font-semibold text-white">已完成 Bybit 註冊？</h2><p className="mt-3 text-sm leading-7 text-secondary">請使用「開通 Bybit 返傭」表單提交 UID，不需要自行撰寫 Email 申請。客服 Email 僅處理 UID 填寫錯誤、找不到 UID、無法歸戶、補件、KYC 轉移、完成後未顯示及返傭紀錄異常。</p><Link href="/rebate/activate" className="button-primary mt-5">繼續開通 Bybit 返傭</Link></div><div className="grid gap-5 md:grid-cols-2">
