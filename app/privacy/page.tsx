...
export default function PrivacyPage() { return <LegalPage eyebrow="法律與隱私" title="隱私權政策" description="本政策說明 BiBeck 在提供網站、計算工具、聯絡與申請服務時，如何處理你主動提供或系統必要產生的資訊。" sections={[
  { heading: "我們可能蒐集的資料", paragraphs: ["一般瀏覽與計算器不要求建立 BiBeck 帳戶。當你主動聯絡、提交返傭開通或另行申請提高比例時，我們才會處理表單中提供的資料。"], items: ["標準開通所需的名稱或稱呼、Bybit UID 與聯絡 Email", "案件編號、案件狀態、返傭比例、申請時間與完成時間", "公開補件訊息、管理操作與通知稽核紀錄", "另行申請提高比例時主動提供的交易量、VIP 等級及證明附件", "為防止濫用所需的提交時間、瀏覽器資訊與網路來源資訊"] },
