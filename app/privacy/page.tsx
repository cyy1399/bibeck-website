...
export default function PrivacyPage() { return <LegalPage eyebrow="法律與隱私" title="隱私權政策" description="本政策說明 BiBeck 在提供網站、計算工具、聯絡與申請服務時，如何處理你主動提供或系統必要產生的資訊。" sections={[
  { heading: "我們可能蒐集的資料", paragraphs: ["一般瀏覽與計算器不要求建立 BiBeck 帳戶。當你主動聯絡或提交高交易量申請時，我們才會處理表單中提供的資料。"], items: ["姓名或稱呼、聯絡 Email 與通訊方式", "交易所名稱、UID、交易量、VIP 等級與申請內容", "你選擇上傳的交易紀錄或證明附件", "為防止濫用所需的提交時間、瀏覽器資訊與網路來源資訊"] },
  { heading: "使用目的", paragraphs: ["資料僅用於回覆詢問、審核返傭或合作資格、確認帳戶關係、維護服務安全，以及依法處理必要的爭議或申訴。BiBeck 不會要求密碼、驗證碼、API Secret、私鑰或助記詞。"] },
