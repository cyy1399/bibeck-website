...
{heading:"蒐集者、目的與資料類別",paragraphs:["蒐集者為 BiBeck。蒐集目的包括返傭帳戶開通、帳戶核對、高交易量與合作需求評估、通知、客服及服務安全；資料類別可能包含名稱或稱呼、Bybit UID、Email、使用者主動提交的交易量或帳戶條件及提交紀錄。BiBeck 不宣稱會自動取得所有 Bybit 交易資料。"]},
{heading:"期間、地區、對象與方式",paragraphs:["資料於完成申請、客服、爭議處理及必要法令遵循期間使用，可能在 BiBeck 網站資料庫、Email 服務及外部返傭後台服務所涵蓋地區，由 BiBeck 及必要服務供應商以電子方式處理。"]},
