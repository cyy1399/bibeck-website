...
{heading:"蒐集者、目的與資料類別",paragraphs:["蒐集者為 BiBeck。蒐集目的包括返傭帳戶開通、帳戶核對、交易量里程碑與 Trader Status 確認、高交易量活動資格評估、合作需求、通知、客服及服務安全；資料類別可能包含名稱或稱呼、Bybit UID、Email、使用者主動提交的交易量或帳戶條件及提交紀錄。BiBeck 不宣稱會自動取得所有 Bybit 交易資料。"]},
