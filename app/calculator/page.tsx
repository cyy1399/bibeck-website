    ...
    <SiteShell>
      ...
      <section className="section-muted border-y border-white/10 px-5 py-20 sm:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1fr_auto] lg:items-end">
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-1"><Link href={REBATE_APPLICATION_URL} className="cta-button button-primary" aria-label="前往 BiBeck Bybit 返傭申請頁">{bybitActionLabels.rebateSignup}</Link><Link href="/rebate" className="cta-button button-secondary">查看返傭說明</Link></div>
        </div>
      </section>
