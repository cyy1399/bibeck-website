export const currencyCodes = [
  "USDT", "USDC", "USD", "TWD", "CNY", "HKD", "JPY", "KRW", "EUR", "GBP", "SGD",
] as const;
...
export const currencies: readonly CurrencyDefinition[] = [
  ...
  { code: "JPY", label: "JPY", symbol: "¥", type: "fiat", decimals: 0, locale: "ja-JP", displayName: "日圓", unitsPerUsdt: 154 },
  { code: "KRW", label: "KRW", symbol: "₩", type: "fiat", decimals: 0, locale: "ko-KR", displayName: "韓元", unitsPerUsdt: 1380 },
  { code: "EUR", label: "EUR", symbol: "€", type: "fiat", decimals: 2, locale: "de-DE", displayName: "歐元", unitsPerUsdt: 0.92 },
  { code: "GBP", label: "GBP", symbol: "£", type: "fiat", decimals: 2, locale: "en-GB", displayName: "英鎊", unitsPerUsdt: 0.78 },
  { code: "SGD", label: "SGD", symbol: "S$", type: "fiat", decimals: 2, locale: "en-SG", displayName: "新加坡幣", unitsPerUsdt: 1.35 },
] as const;
...
export interface ExchangeRateProvider {
  ...
  getUnitsPerUsdt(code: CurrencyCode): number | null;
}

export const bundledEstimateRateProvider: ExchangeRateProvider = {
  id: exchangeRatePolicy.provider,
  label: exchangeRatePolicy.label,
  updatedAt: exchangeRatePolicy.updatedAt,
  getUnitsPerUsdt(code) {
    const rate = currencyByCode[code]?.unitsPerUsdt;
