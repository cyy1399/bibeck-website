...
export const rebateActivationCases = pgTable("rebate_activation_cases", {
  ...
  applicationType: text("application_type").notNull().default("standard"),
  volumeRange: text("volume_range").notNull().default("uncertain"),
  applicantMessage: text("applicant_message"),
  status: text("status").notNull().default("PENDING"),
  rebateRate: numeric("rebate_rate", { precision: 5, scale: 2, mode: "number" }).notNull().default(35),
